...
class AggregationChain:
    AGGREGATION_PROMPT_TEMPLATE = """You are an aggregator of knowledge found on the Internet for the following queries:
{formatted_queries}
...
"""
    ...
    def create(self):
        ...
        return RunnableParallel({
            "response": RunnablePassthrough().assign(
                formatted_queries=self._format_queries,
    ...
    def _format_queries(self, state):
        return "\n".join(state["queries"])
